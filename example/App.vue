  ...
  <div id="app">
    ...
    <timeline timelineTheme="lightblue">
      ...
      <timeline-item lineColor="#a6ade4">
        <p>I write <a href="https://github.com/luyilin/Aoba" target="_blank">Aoba</a></p>
        <p class="append">A tool to create a resume easier.</p>
      </timeline-item>
      <timeline-item :hollow="true">
        <p>And <a href="https://github.com/luyilin/Maltose" target="_blank">Maltose</a></p>
